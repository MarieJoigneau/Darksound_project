---
title: "simu_micro_covar_in_occu"
...
## ---- LOAD .RData + working directory ------------------------------------------------

Data Marie (à adapter pour vous)
```{r}
load("D:/OneDrive/ACO 3eme annee 2022-2023/Projet M2 - Oiseaux/Bird-population-estimationFINALFINAL/Nos simulations/dataMarie.RData")
# à changer selon la personne

setwd("D:/OneDrive/ACO 3eme annee 2022-2023/Projet M2 - Oiseaux/Bird-population-estimationTHE_LAST")
```
...
df_micro$ID <-1:nrow(df_micro)

plot(df_micro$micros_x,df_micro$micros_y,xlim=c(0,1.2),ylim=c(0,1.2))
```
...
# 2) Génération du tableau de coordonnées des oiseaux pour toute l'heure
...
# 2) Extraction moyenne + ecart-type de la proba d'occupancy + detection
