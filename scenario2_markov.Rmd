...
cette fonction renvoie une liste de 0 ou 1 de longueur nbr micro. La proba de détecter l'oiseau dépend de si l'oiseau chante ou pas. La ligne "detect <- 1" n'est activée que pour le scénario 3 où la probabilité de détecter l'oiseau dépend de s'il chante ou pas et de la distance au micro (atténuation)
